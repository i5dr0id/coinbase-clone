<template>
  <div class="instruction-section">
    <div class="instuction-section-flex">
      <h1 class="instruction-section-text-title">Get started in a few minutes</h1>
      <span
        class="instruction-section-text-sub"
      >Coinbase supports a variety of the most popular digital currencies.</span>
      <div class="icon-images-container">
        <div class="icon-text-step">
          <svg
            width="64"
            height="60"
            viewBox="0 0 64 60"
          ...
          <h3 class="icon-text-step">Create an account</h3>
        </div>
        ...
        <div class="icon-text-step">
          ...
          <h3 class="icon-text-step">Link your bank account</h3>
        </div>
        <div class="dash-line"></div>
        <div class="icon-text-step">
          <svg
          ...
          >
            ...
            <path
              ...
              fill="#1652F0"
            ></path>
            <path d="M32 9h-3V6h-2v3h-3v2h3v3h2v-3h3V9zM52 27v-2h-8v2h8z" fill="#fff"></path>
          </svg>
          <h3 class="icon-text-step">Start buying & selling</h3>
        </div>
      </div>
    </div>
  </div>
...
.instruction-section-text-title {
  line-height: 48px;
  font-size: 40px;
  color: rgb(15, 50, 86);
  font-weight: bold;
