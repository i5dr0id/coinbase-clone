<template>
  <div class="value-section">
    <div class="value-section-flex">
      <div class="value-seaction-column">
        <h1 class="value-section-text-title">The most trusted cryptocurrency platform</h1>
        <p class="value-section-text-sub">Here are a few reasons why you should choose Coinbase</p>
        <div class="value-section-features">
          <div class="value-feature-1">
            <svg
              width="64"
              height="64"
              viewBox="0 0 64 64"
            ...
            >
              ...
              <path
                d="M41.19 20.81c-5.07-5.07-13.32-5.07-18.38 0-5.06 5.07-5.07 13.32 0 18.38 2.53 2.53 5.86 3.8 9.19 3.8 3.33 0 6.66-1.27 9.19-3.8 5.07-5.07 5.07-13.31 0-18.38zM32 19c2.5 0 5 .85 7.04 2.55l-2.85 2.85A6.99 6.99 0 0 0 32 23c-1.53 0-2.98.5-4.19 1.4l-2.85-2.85A11.03 11.03 0 0 1 32 19zm3.54 14.54c-.95.94-2.2 1.46-3.54 1.46-1.34 0-2.59-.52-3.54-1.46A4.952 4.952 0 0 1 27 30c0-1.33.52-2.59 1.46-3.54.94-.95 2.2-1.46 3.54-1.46 1.34 0 2.59.52 3.54 1.46.95.94 1.46 2.21 1.46 3.54s-.52 2.59-1.46 3.54zM23.55 22.96l2.85 2.85A6.99 6.99 0 0 0 25 30c0 1.53.5 2.98 1.4 4.19l-2.85 2.85a11.018 11.018 0 0 1 0-14.08zm1.41 15.49l2.85-2.85a6.969 6.969 0 0 0 8.38 0l2.85 2.85a11.018 11.018 0 0 1-14.08 0zm15.49-1.41l-2.85-2.85c.9-1.2 1.4-2.65 1.4-4.19 0-1.53-.5-2.98-1.4-4.19l2.85-2.85a11.018 11.018 0 0 1 0 14.08z"
                fill="#fff"
              ></path>
            </svg>
...
<style scoped>
.value-section .value-section-flex {
  display: flex;
  flex-direction: row;
