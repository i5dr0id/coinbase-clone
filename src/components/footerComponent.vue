  ...
  <div class="footer">
    <div class="footer-flex">
      <div class="footer-flex-column">
        ...
        <div class="footer-column-item">
          <h3 class="footer-column-item-title">Learn</h3>
          <router-link class="footer-router-link" to="#">
            <a>Buy Bitcoin</a>
          </router-link>
          <router-link class="footer-router-link" to="#">
            <a>Buy Bitcoin Cash</a>
          </router-link>
          <router-link class="footer-router-link" to="#">
            <a>Buy Ethereum</a>
          </router-link>
        ...
        <div class="footer-column-item">
          <h3 class="footer-column-item-title">Company</h3>
          <router-link class="footer-router-link" to="#">
            <a>About</a>
          </router-link>
          <router-link class="footer-router-link" to="#">
        ...
        <div class="footer-column-item">
          <h3 class="footer-column-item-title">Social</h3>
          <router-link class="footer-router-link" to="#">
            <a>Blog</a>
          </router-link>
          <router-link class="footer-router-link" to="#">
